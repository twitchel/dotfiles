...
fpath+=( "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-zpm-zsh-SLASH-clipboard" )
source "$HOME/.cache/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-zpm-zsh-SLASH-clipboard/clipboard.plugin.zsh"
